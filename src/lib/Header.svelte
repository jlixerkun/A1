...
<header class={status}>
  <div class="container">
    <a href="/" title="inicio" rel="noreferrer" class="logo">
      <img src={amarilogo} alt="Logo amarilo" />
    </a>
    <nav class="menu">
      <ul>
        <li><Button label="Reservar cita" /></li>
        
        <li><a href="/proyectos">Proyectos</a></li>
        <li><a href="/herramientas">Herramientas</a></li>
        <li><a href="/mi-cuenta">Mi cuenta</a></li>
        <li><a href="https://web.whatsapp.com/" class="contact-wa"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- <li><a href="https://web.whatsapp.com/" class="contact-wa"><img src={whatslogo} alt="whatsapp"></a></li> -->
...
<style>
  ...
  .container {
    width: 90%;
    margin: auto;
    /* border: 1px solid rgb(198, 11, 11); */
  }
